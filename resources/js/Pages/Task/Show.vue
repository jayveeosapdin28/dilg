      ...
      <div class="max-w-5xl mx-auto px-6 ">
          ...
          >
            ...
            <template #column_file_url="{props}">
              <div class="flex justify-end items-center">
                <a :href="props.file_url" :download="file?.file?.file_name" class="flex gap-2 hover:bg-primary-600 hover:text-white items-center border border-primary-600 text-primary-600 px-3 py-1 rounded-full">
        ...
        <div v-if="hasRole('User')" class="mt-14 bg-white  space-y-8">
          <div v-if="file">
            ...
            <a class="text-primary-500 hover:underline cursor-pointer font-semibold" :download="file?.file?.file_name ?? 'default'" :href="file?.file_url"
               target="_blank">
